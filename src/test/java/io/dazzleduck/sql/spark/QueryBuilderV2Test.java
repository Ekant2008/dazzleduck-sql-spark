...
public class QueryBuilderV2Test {
    ...
    public void testWithoutAggregation() throws SQLException, IOException {
        ...
        var datasourceOptions = new DatasourceOptions("localhost", null, "example/data/parquet/kv","read_parquet", List.of("p"), Duration.ofMinutes(10), new Properties(), DatasourceOptions.SourceType.HIVE, null, null, null, DatasourceOptions.Protocol.GRPC);
